...
class BookCanvas(canvas.Canvas):
    ...
    def draw_page_decorations(self, page_count):
        ...
        self.drawString(54, 32, "Capítulo 5: El Ancla Humana")
...
def generate_chapter5_pdf(md_path, output_filename):
    ...
    while i < len(lines):
        ...
        # Encabezado h4 (#### 1. Jean-Luc Girard: ...)
        if line.startswith("#### "):
...
if __name__ == "__main__":
    ...
    md_file = os.path.join(base_dir, "novela", "capitulos", "capitulo_5.md")
    out_file1 = os.path.join(base_dir, "novela", "Capitulo_5_El_Ancla_Humana.pdf")
    out_file2 = os.path.join(base_dir, "Capitulo_5_El_Ancla_Humana.pdf")
    
    generate_chapter5_pdf(md_file, out_file1)
