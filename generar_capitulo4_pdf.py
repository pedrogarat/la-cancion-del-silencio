...
class BookCanvas(canvas.Canvas):
    ...
    def draw_page_decorations(self, page_count):
        ...
        self.drawString(54, 32, "Capítulo 4: El Vértigo de las Naciones")
...
def generate_chapter4_pdf(md_path, output_filename):
...
if __name__ == "__main__":
    ...
    md_file = os.path.join(base_dir, "novela", "capitulos", "capitulo_4.md")
    out_file1 = os.path.join(base_dir, "novela", "Capitulo_4_El_Vertigo_de_las_Naciones.pdf")
    out_file2 = os.path.join(base_dir, "Capitulo_4_El_Vertigo_de_las_Naciones.pdf")
    
    generate_chapter4_pdf(md_file, out_file1)
